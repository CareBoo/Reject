...
<root>
  ...
  ├── Editor
  │   ├── Jasonboukheir.Reject.Editor.asmdef
  │   └── EditorExample.cs
  ├── Runtime
  │   ├── Jasonboukheir.Reject.asmdef
  │   └── RuntimeExample.cs
  ├── Tests
  │   ├── .tests.json
  │   ├── Editor
  │   │   ├── Jasonboukheir.Reject.Editor.Tests.asmdef
  │   │   └── EditorExampleTest.cs
  │   └── Runtime
  │        ├── Jasonboukheir.Reject.Tests.asmdef
...
1. Enter your package name. The name you choose should contain your default organization followed by the name you typed. For example: `Jasonboukheir.Reject`.
...
To use the Inspector, select the `package.json` file in the Project browser. The **Package Reject Manifest** page opens for editing.
...
* Store Editor-specific code under a root editor assembly definition file:
  ...
  `Editor/Jasonboukheir.Reject.Editor.asmdef`

* Store runtime-specific code under a root runtime assembly definition file:

  `Runtime/Jasonboukheir.Reject.asmdef`

* Configure related test assemblies for your editor and runtime scripts:

  `Tests/Editor/Jasonboukheir.Reject.Editor.Tests.asmdef`

  `Tests/Runtime/Jasonboukheir.Reject.Tests.asmdef`
...
Use the `Documentations~/Reject.md` documentation file to create preliminary, high-level documentation. This document should introduce users to the features and sample files included in your package.  Your package documentation files will be used to generate online and local docs, available from the Package Manager UI.
